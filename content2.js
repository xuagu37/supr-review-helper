...
function togglePanel() {
  ...
  document.getElementById("supr-close").onclick = () => panel.remove();
...
function scrapePastUsagePIText() {
  ...
  const piSectionRoot = piBlock.piHeading.parentElement || root;

  const projects = extractPIProjectH4s(piSectionRoot);
